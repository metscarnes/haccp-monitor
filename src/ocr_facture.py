...
MODEL = os.environ.get("OCR_MODEL", "claude-sonnet-5")

# Prix par million de tokens (entrée, sortie), en USD. Sonnet 5 : tarif intro
# 2/10 jusqu'au 31/08/2026, puis 3/15 (standard retenu ici — le coût affiché
# sera légèrement surestimé pendant la période intro, jamais sous-estimé).
_PRIX = {
